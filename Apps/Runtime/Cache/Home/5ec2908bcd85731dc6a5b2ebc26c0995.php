...
<script src="/jsjkxyjs/Public/e8home/default/js/nocopy.js" type="text/javascript"></script>
...
<!--text_index开始-->
<div id="text_index">
	<div class="title">当前位置：<a href="/jsjkxyjs/index.php/Index/index">首页</a>&gt;&gt;<a href="/jsjkxyjs/index.php/List/article/class/<?php echo ($classList["id"]); ?>"><?php echo ($classList["classname"]); ?></a></div>
    <div class="text_content">
        <h1><?php echo ($contentList["title"]); ?></h1>
     <div class="info"><?php echo (date("Y-m-d H:m:s",$contentList["addtime"])); ?>&nbsp;&nbsp; 阅读：<?php echo ($contentList["views"]); ?><a href=""><?php echo ($contentList["source"]); ?></a></div>
     <p><?php echo ($contentList["content"]); ?>
     <p class="next_bianzhi"> (文章编制）<?php echo ($contentList["author"]); ?></p>
