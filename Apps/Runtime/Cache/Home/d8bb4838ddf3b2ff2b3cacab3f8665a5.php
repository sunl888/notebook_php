...
<div class="container">
  <h2>写日记</h2><hr>
  <form enctype="multipart/form-data" id="J_write" action="" method="post" class="form-horizontal">
    ...
    <div class="control-group">
      <label>标题: <input type="text" name="location" placeholder="写日记的地点"></label>
    </div>
    <div class="control-group info">
      ...
      <div class="control-group">
        <label class="inline"> 
          <input name="privacy" type="checkbox" value="1">&nbsp;只有自己可见</label>
       </div>
          <div class="control-group">
