...
<!--text_index开始-->
<div id="text_index">
	<p class="text_title">当前位置：<a href="/jsjkxyjs/index.php/Index/index">首页</a>&gt;&gt;<a href="/jsjkxyjs/index.php/List/article/class/<?php echo ($classList["id"]); ?>"><?php echo ($classList["classname"]); ?></a>
	</p>
    <div class="text_content">
        <h1><?php echo ($classList["classname"]); ?></h1>
     <p><?php echo ($classList["content"]); ?>
    </div>
</div>
<!--text_index结束-->
