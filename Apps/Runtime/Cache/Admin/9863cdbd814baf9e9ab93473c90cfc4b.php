...
<body>
	...
	<div class="login">
        ...
        <form action="/notebook_php/admin.php/Login/login" method="post">
        <div class="l-form">
        	<p>
            ...
            <p>
                ...
                <img id="verifyCode" src="/notebook_php/admin.php/Login/createVerify" onclick="this.src='/notebook_php/admin.php/Login/createVerify?time=<?php echo time();?>'" />
            </p>
            <p>
            	<input type="submit" value="提交" />
                <a href="/notebook_php/admin.php/Findpassword/index" class="a-1">忘记密码</a>
            </p>
        </div>
        </form>
