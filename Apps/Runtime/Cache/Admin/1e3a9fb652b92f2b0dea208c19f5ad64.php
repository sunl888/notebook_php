			...
			<div class="tabbable">
				...
				<div class="tab-content">
                    ...
                    <p class="title background-blue">栏目列表</p>
                      <form action="/jsjkxyjs/admin.php/Class/sort" method="post">
						<table class="table table-hover">
                            ...
                            <?php if(is_array($classList)): foreach($classList as $key=>$class): ?><tr>
                                    ...
                                    <td>
                                    	<a href="#">访问</a>  |
                                    	<?php if($class["type"] == 2): ?><a href="/jsjkxyjs/admin.php/Class/editlink/id/<?php echo ($class["id"]); ?>">修改</a>  |
                                    	<?php else: ?>
                                    		<a href="/jsjkxyjs/admin.php/Class/edit/id/<?php echo ($class["id"]); ?>">修改</a>  |<?php endif; ?>
                                        <a href="javascript:void(0);" onclick="return confirm('/jsjkxyjs/admin.php/Class/del/id/<?php echo ($class["id"]); ?>','确认删除?');">删除</a>
                                    </td>
