        ...
        <div class="col-sm-12">
			<div class="tabbable">
				<ul class="nav nav-tabs">
                    <?php if($cancel != 0): ?><li><span><a href="/jsjkxyjs/admin.php/Role/index" class="e8-prompt" style="font-size:12px;">&lt;返回角色管理</a></span>&nbsp;&nbsp;&nbsp;</li><?php endif; ?>
					<li class="active">
						<a  href="#">管理员管理</a>
					</li>

					<li>
						<a  href="/jsjkxyjs/admin.php/User/add">添加管理员</a>
					</li>
				</ul>
                            ...
                            <tbody>
                                <?php if(is_array($userArr)): $k = 0; $__LIST__ = $userArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($k % 2 );++$k;?><tr>
                                        ...
                                        <td class="align-center">
                                            <a href="/jsjkxyjs/admin.php/User/edit/id/<?php echo ($user["id"]); ?>/mw/<?php echo ($user["mw"]); ?>">修改</a>  |
                                            <a href="javascript:void(0);" onclick="return confirm('/jsjkxyjs/admin.php/User/del/id/<?php echo ($user["id"]); ?>/mw/<?php echo ($user["mw"]); ?>','确定删除?');">删除</a>
                                        </td>
