...
<html lang="zh-CN">
  <head>
	...
	<!-- 加载百度编辑器js -->
    <script type="text/javascript" charset="utf-8" src="/jxx/Public/e8admin/default/lib/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/jxx/Public/e8admin/default/lib/ueditor/ueditor.all.min.js"></script>
    <script type="text/javascript" charset="utf-8" src="/jxx/Public/e8admin/default/lib/ueditor/lang/zh-cn/zh-cn.js"></script>
  </head>
        ...
        <div class="col-sm-12">
			<div class="tabbable">
				<ul class="nav nav-tabs">
					<li>
						<a href="/jxx/admin.php/Class/index">栏目管理</a>
					</li>

					<li  class="active">
						<a href="/jxx/admin.php/Class/add">添加栏目</a>
					</li>
                    
                    <li>
						<a href="/jxx/admin.php/Class/addlink">添加外部链接栏目</a>
					</li>
				</ul>
				...
				<div class="tab-content">
					...
					<div class="tab-pane in active">
                     ...
                     <form action="/jxx/admin.php/Class/add" method="post" enctype="multipart/form-data">
                        <div class="tab-content">
