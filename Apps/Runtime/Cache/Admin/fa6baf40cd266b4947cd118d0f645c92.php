...
<html lang="zh-CN"><head>
    ...
    <!-- 颜色选择组件 css -->
    <link rel="stylesheet" href="/jsjkxyjs/Public/e8admin/default/lib/Colorpicker/evol.colorpicker.css">
    <!-- 时间选择组件 css -->
        ...
        <div class="col-sm-12">
			<div class="tabbable">
				<ul class="nav nav-tabs">
					<li><a href="/jsjkxyjs/admin.php/Teacher">教师管理</a></li>
                    <li  class="active"><a href="#">添加教师</a></li>
                </ul>
				</ul>
				...
				<div class="tab-content">
					...
					<div  class="tab-pane in active">
						<p class="title background-blue">添加教师</p>
                        <form action = "/jsjkxyjs/admin.php/Teacher/add" enctype="multipart/form-data"  method = "post">
                        	 <table class="table-form" >
                                ...
                                <tr>
                                    <th>职务:</th>
                                    <td>
                                        <input class="form-control input-sm wid-3" type="text" placeholder="" name="position">
                                    </td>                                
                                </tr>
                                <tr>
                                    <th>图片:</th>
