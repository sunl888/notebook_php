        ...
        <div class="col-sm-12">
			<div class="tabbable">
				<ul class="nav nav-tabs">
					...
					<li>
						<a  href="/jsjkxyjs/admin.php/Config/email">邮箱配置</a>
					</li>

					<li>
						<a  href="/jsjkxyjs/admin.php/Config/file">附件配置</a>
					</li>
                    <li>
						<a href="/jsjkxyjs/admin.php/Config/master">高级配置</a>
					</li>
                    <li>
						<a href="/jsjkxyjs/admin.php/Config/extend">扩展配置</a>
					</li>
				</ul>

				<div class="tab-content">
					<div  class="tab-pane in active"><a href="/jsjkxyjs/Public/e8admin/default/js"></a>
						<p class="title background-blue">站点配置</p>
                        <form action="/jsjkxyjs/admin.php/Config/index" method="post">
