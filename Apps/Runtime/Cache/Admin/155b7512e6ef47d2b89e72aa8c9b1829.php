        ...
        <div class="col-sm-12">
			<div class="tabbable">
				<ul class="nav nav-tabs">
                    <?php if($cancel != 0): ?><li><span><a href="/jsjkxyjs/admin.php/Link/term" class="e8-prompt" style="font-size:12px;">&lt;返回角色管理</a></span>&nbsp;&nbsp;&nbsp;</li><?php endif; ?>
					<li class="active"><a href="#">友情链接</a></li>
					<li><a href="/jsjkxyjs/admin.php/Link/add">添加友情链接</a></li>
                    <li><a href="/jsjkxyjs/admin.php/Link/term">分类管理</a></li>
                    <li><a href="/jsjkxyjs/admin.php/Link/termadd">添加分类</a></li>
				</ul>
				...
				<div class="tab-content">
					<div  class="tab-pane in active">
                        ...
                        <form action="/jsjkxyjs/admin.php/Link/index" method="post">
                        ...
                        <form action="/jsjkxyjs/admin.php/Link/linkEdit" method="post" >
                            <table class="table table-hover">
                            	...
                            	<?php if(is_array($linkList)): foreach($linkList as $key=>$link): ?><tr>
	                                	...
	                                	<td class="align-center">
	                                		<a href="/jsjkxyjs/admin.php/Link/edit/id/<?php echo ($link["id"]); ?>/mw/<?php echo ($link["mw"]); ?>">修改</a>|&nbsp;
											<a href="javascript:void(0);" onclick="return confirm('/jsjkxyjs/admin.php/Link/del/id/<?php echo ($link["id"]); ?>','确定删除?');">删除</a>
	                                	</td>
                            ...
                            <div class="admin-add">
                            	<button class="btn btn-primary btn-sm" type="button" onclick="javascript:treatCon('/jsjkxyjs/admin.php/Link/Del')">删除</button>
                            </div>
                        </form>                      
					</div>
				</div>
