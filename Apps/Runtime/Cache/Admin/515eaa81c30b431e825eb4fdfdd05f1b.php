        ...
        <div class="col-sm-12">
			<div class="tabbable">
				<ul class="nav nav-tabs">
					...
					<li>
						<a href="/jsjkxyjs/admin.php/Role/add">添加角色</a>
					</li>
						...
						<table class="table table-hover">
                            ...
                            <tbody>
                                <?php if(is_array($roleArr)): $i = 0; $__LIST__ = array_slice($roleArr,0,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$role): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="align-center">| <a href="/jsjkxyjs/admin.php/User/index/role_id/<?php echo ($role["id"]); ?>">成员管理</a> | &nbsp;&nbsp;
                                        </td>
                                ...
                                <?php if(is_array($roleArr)): $i = 0; $__LIST__ = array_slice($roleArr,1,null,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$role): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="align-center">
                                            <a href="/jsjkxyjs/admin.php/Role/access/id/<?php echo ($role["id"]); ?>/mw/<?php echo ($role["mw"]); ?>">权限设置 </a>  |
                                            <a href="/jsjkxyjs/admin.php/User/index/role_id/<?php echo ($role["id"]); ?>">成员管理 </a> |
                                            <a href="/jsjkxyjs/admin.php/Role/edit/id/<?php echo ($role["id"]); ?>/mw/<?php echo ($role["mw"]); ?>"> 修改 </a> |
                                            <a href="javascript:void(0);" onclick="return confirm('/jsjkxyjs/admin.php/Role/del/id/<?php echo ($role["id"]); ?>/mw/<?php echo ($role["mw"]); ?>','确定要删除吗?如果该角色下有子角色或者该角色下有用户则不可以被删除!');"> 删除 </a>
                                        </td>
                                    </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
                        </table>
