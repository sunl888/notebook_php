...
<html lang="zh-CN">
  ...
  <body>
   <form action="/jsjkxyjs/admin.php/Content/add" method="post" enctype="multipart/form-data">
        		...
        		<table class="table-form">
                    ...
                    <tr>
                        ...
                        <div class="img-upload wid-100">
                        	<p>
                        	<img src="/jsjkxyjs/Public/e8admin/default/img/img-72.png" alt="..." class="img-thumbnail"></p>
    ...
    <!-- 颜色选择组件js -->
    <script src="/jsjkxyjs/Public/e8admin/default/lib/Colorpicker/evol.colorpicker.js"></script>
    <!-- 时间选择组件js -->
