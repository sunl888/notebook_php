        ...
        <div class="col-sm-12">
			<div class="tabbable">
				<ul class="nav nav-tabs">
					<li class="active">
						<a data-toggle="tab" href="/jsjkxyjs/admin.php/Log/index">后台登录日志</a>
					</li>

					<li>
					<a data-toggle="tab" href="javascript:void(0);" onclick="return confirm('/jsjkxyjs/admin.php/Log/del','确定删除?');">删除一个月前的登录日志</a>
					</li>
				</ul>
				...
				<div class="tab-content">
					<div id="log" class="tab-pane in active">
                        ...
                        <form action = "/jsjkxyjs/admin.php/Log/index" method="post">
